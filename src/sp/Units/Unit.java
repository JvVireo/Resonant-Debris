...
public abstract class Unit {
    ...
    protected Unit(int startX, int startY, long id, String imageFile) {
        ...
        try {
            if(ismodded) {
                File directory = new File(System.getProperty("user.home") + "/AppData/Roaming/ResonantDebris/moddedSprites");

                    if (!directory.exists()) {
                        directory.mkdirs();
                    }
                imageFile = System.getProperty("user.home") + "/AppData/Roaming/ResonantDebris/moddedSprites/" + imageFile;
            }else {
    ...
    public abstract void setIsmodded();
}