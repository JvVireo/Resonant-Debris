...
public class SoundLibrary {
    ...
    private static Clip getClip(String soundFilePath) {
        ...
        try {
            InputStream nonshielded = SoundLibrary.class.getClassLoader().getResourceAsStream(soundFilePath);

            if (nonshielded != null) {
                BufferedInputStream soundFile = new BufferedInputStream(nonshielded);
